...
while(iterationcard <= channelcount) {
	if (iterationcard == 1) {
		var htmlcard = '<div class="channel_'+iterationcard+' card activee"><img src="'+imgUrl+'" class="channelImage"><div class="card-content"><div class="channelName">'+chanName+'</div><div class="odometer subscriberCount">1100</div></div></div>';
	} else {
		var htmlcard = '<div class="channel_'+iterationcard+' card"><img src="'+imgUrl+'" class="channelImage"><div class="card-content"><div class="channelName">'+chanName+'</div><div class="odometer subscriberCount">1100</div></div></div>';
	}
...
function fn60sec() {
	...
	$.getJSON('https://lazyasskid.000webhostapp.com/channels.json', function(channels) {
